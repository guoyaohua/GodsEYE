package com.guoyaohua.godseye.track.utils;
...
public class MapUtil {
     ...
     * @param myApplication
     */
    public void setCenter(MyApplication myApplication) {
        ...
        String lastLocation = myApplication.trackConf.getString(Constants.LAST_LOCATION, null);
