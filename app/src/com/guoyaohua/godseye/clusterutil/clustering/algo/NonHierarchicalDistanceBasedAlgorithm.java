...
package com.guoyaohua.godseye.clusterutil.clustering.algo;
...
import com.guoyaohua.godseye.clusterutil.projection.Bounds;
...
import com.guoyaohua.godseye.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private static class QuadItem<T extends ClusterItem> implements PointQuadTree.Item, Cluster<T> {
        ...
        public boolean equals(Object o) {
            ...
            return mClusterItem != null ? mClusterItem.equals(quadItem.mClusterItem) : quadItem.mClusterItem == null;

        }

        @Override
        public int hashCode() {
            return mClusterItem != null ? mClusterItem.hashCode() : 0;
        }
    }
}
